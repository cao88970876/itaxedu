                ...
                <ul class="coupon-list"
                    ...
                    <li v-for="(item,index) in couponList"
                        ...
                        <label @click.prevent="clickItem(item)" class="pointer">
                            ...
                            <div class="clear">
                                <div class="rebate ellipsis left" v-if="item.type===1"
                                     v-text="item.discounts + '元'"></div>
                                <div class="rebate ellipsis left" v-if="item.type===2"
                                     v-text="item.discounts * 10 + '折'"></div>
    ...
    export default {
        ...
        methods: {
            ...
            clickItem(item) {
                ...
                this.$emit('couponCheck', this.checkVal)
            ...
            isAble(item) {
                // console.log("打印的ITEM",item)
                //console.log("type",this.type)
                // console.log("优惠券的this。price",this.price)
                return ((this.type === 1 && item.model_type === 1) ||
                    (this.type === 2 && item.model_type === 5) ||
