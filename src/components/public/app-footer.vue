                ...
                <section class="clear">
                    <div class="left">
                        ...
                        <div class="info-list">
                            ...
                            <span>公司地址：北京市海淀区高梁桥斜街59号中坤大厦1506室</span>
                        </div>
                        <div class="info-list">
                            <span class="icon telp"></span>
                            <span>咨询电话：010-62125663</span>
                        </div>
                        <div class="info-list">
                            <span class="icon chuz"></span>
                            <span>传真：010-81503170</span>
                        </div>
                        <div class="info-list">
                            <span class="icon netpath"></span>
