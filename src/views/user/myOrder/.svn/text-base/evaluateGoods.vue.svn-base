<template>
    <div class="evaluateGoods_page">
        ...
        <div class="receipt_user">
            <i class="map_icon"><img src="../../../assets/image/ic_113.png" alt=""></i><span v-text="address.name"></span><span class="phone" v-text="address.phone"></span><span class="addres">{{address.provinces}}{{address.citys}}{{address.areas}}{{address.address}}</span><i
                ...
                <li>
                    <div class="goods">
                        ...
                        <div class="orderSend_btn">
                            ...
                            <div @click="$router.push({name:'commentGoods',query:{orderId:goods.order_num,id:id}})">立即评价</div>
                        </div>
                    </div>
                </li>
            </ul>
