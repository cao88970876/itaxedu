<template>
    <div class="inquiriesDetails_page">
        <div class="header">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                <el-breadcrumb-item :to="{ path: '/user/myAnswer/myAnswerHome' }">我的问答</el-breadcrumb-item>
                <el-breadcrumb-item :to="{ path: '' }">提问详情</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <div class="answer_questions" v-show="zwquestions.status ===1">
            <ul>
                <li v-for="item in zwanswers">
                    ...
                    <div class="answer_img">
                        <div v-for="j in item.img_data" @click="enlarge(j)">
