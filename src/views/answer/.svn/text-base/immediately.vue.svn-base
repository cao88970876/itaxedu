<template>
    <div class="immediately_page page-content">
        ...
        <div class="title">
            ...
            <!--<el-breadcrumb-item :to="{ path: '/answer/immediately'}">追问</el-breadcrumb-item>-->
            <!--</el-breadcrumb>-->
            立即追问
        </div>
        ...
        <div class="questions_inp">
            <el-input type="textarea" resize="none" maxlength="999" @input="descInput" v-model="questionsText" :autosize="{ minRows: 10, maxRows: 50}"
...
<script>
    ...
    export default {
        ...
        methods: {
            //获取输出框的字数
            descInput() {
                this.textlength = this.questionsText.length;
            },
            show() {
        ...
        mounted() {
            ...
            this.id = this.$route.query.quzi_id
            this.price = this.$route.query.price
            console.log(this.uid, this.id, this.price)
